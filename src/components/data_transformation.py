...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            # Categorical Pipeline: Impute missing with mode, OneHotEncode, then scale
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # --- FIX: Avoided using both 'columns' and 'axis' to prevent Pandas conflict ---
            ...
            # Combine features and target into a single numpy array for the next stage
            ...
            # Save the pickle file for later use in prediction
            save_object(
